...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void submit_Button(View v) {
        ...
        if (chkString(Name, ID, PW, StudNum, UnivName)) {
            ...
            Insert(strName, strId, strPw, strStuNum, strSchoolName);

            finish();
        }
    }
    public void Insert(String strName, String strId ,String strPw, String strStuNum, String strSchoolName) {
        class InsertTask extends AsyncTask<String, Void, String> {
            ...
            */
            ...
            protected String doInBackground(String[] params) {
                ...
                String studentNumber = (String) params[1];
                String schoolName = (String) params[2];
        ...
        insertTask.execute(strName, strId, strPw, strStuNum, strSchoolName);
    }
